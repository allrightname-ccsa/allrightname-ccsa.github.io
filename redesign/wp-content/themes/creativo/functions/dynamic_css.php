	...
	*/
	...
	if( ($data['header_position'] != 'left' ) && ($data['header_position']!='right' )) {		
	    ...
	    if($individual_header_css == "business"){
			...
			#branding {
	    		...
	    		if($data['logo_resize']) {
	    		?>
					min-width: <?php echo $data['logo_resize']; ?>px;
	    		<?php
	    		}
	    		else {
				?>
					min-width: <?php echo $logo_attr[1]; ?>px;
				<?php
				}	
				?>
			...
			<?php
			$nav_align = $data['header_el_pos'] != 'normal' ? $data['header_el_pos'] : 'right';
			...
			.additional_icons {
				...
				$size = ( $data['woo_cart'] && class_exists('woocommerce') ) ? ( $size + 55 ) : $size;
			...
			.additional_icons #header_search_wrap a i.fa-remove {
				left:0;
				position:absolute;
			}			
	...
	if( get_post_meta($post->ID, 'pyre_transparent_header', true) == 'yes' ) {
		...
		.header_transparent {
			...
			width: 100%;
			box-shadow: none;
			border-bottom-color: <?php echo get_post_meta($post->ID, 'pyre_transparent_header_border_color', true); ?>;
			-webkit-box-shadow: none;
		}
		.header_transparent .additional_icons ul{
			border-color: <?php echo get_post_meta($post->ID, 'pyre_transparent_header_icons_border_color', true); ?>;
		}
