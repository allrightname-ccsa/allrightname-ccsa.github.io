			...
			<div class="ls-box ls-product-banner ls-auto-update <?php echo  $validity ? 'active' : '' ?>">
				...
				<form method="post" class="inner">
					...
					<div class="main-controls">
						...
						<a target="_blank" class="button button-hero purchase-button" href="http://codecanyon.net/cart/add_items?ref=rockythemes&amp;item_ids=1362246"><?php _e('Purchase license', 'LayerSlider') ?></a>
					</div>
